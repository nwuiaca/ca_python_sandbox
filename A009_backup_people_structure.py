"""
SCRIPT TO BACKUP PEOPLE STRUCTURE TO NWUIA WEB DATA
Script: A009_backup_people_structure.py
...
def ia_mysql_backup_people_structure(s_source_database: str = "Web_ia_nwu", s_target_database: str = "Web_nwu_ia"):
    ...
    *****************************************************************************"""
    ...
    target_table: str = "ia_people_structure"
    ...
    if l_return:
        ...
        ****************************************************************************"""
        ...
        so_curs.execute("SELECT * FROM X000_PEOPLE_STRUCT")
...
if __name__ == '__main__':
    try:
        ia_mysql_backup_people_structure()
