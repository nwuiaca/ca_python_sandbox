...
Where
    ...
    Then (assi.ia_user_sysid = 855 And assi.ia_assi_year = Year(Date_add(Now(), Interval -1 Year)))
      Or (assi.ia_user_sysid = 855 And assi.ia_assi_year < Year(Date_add(Now(), Interval -1 Year)) And assi.ia_assi_priority < 9)
      Or (assi.ia_user_sysid = 855 And assi.ia_assi_finishdate between Concat(Year(Date_add(Now(), Interval -2 Year)), '1001') And Concat(Year(Date_add(Now(), Interval -1 Year)), '0930'))
    Else (assi.ia_user_sysid = 855 And assi.ia_assi_year = Year(Now()))
