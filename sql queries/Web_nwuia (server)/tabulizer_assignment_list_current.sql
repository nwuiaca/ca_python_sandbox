Select
    Case
        ...
        Then Concat(cate.ia_assicate_name, ' - ', user.name)
        Else cate.ia_assicate_name
    End As Category,
    ...
    Date_Format(assi.ia_assi_editdate, '%y%m%d') As Edited,
...
Where
    Case
        ...
        Then (assi.ia_user_sysid = 855 And assi.ia_assi_year = Year(Date(Now()))) Or
            (assi.ia_assi_permission = 855 And assi.ia_assi_year = Year(Date(Now()))) Or
            (assi.ia_user_sysid = 855 And assi.ia_assi_year < Year(Date(Now())) And assi.ia_assi_priority < 9) Or
            (assi.ia_assi_permission = 855 And assi.ia_assi_year < Year(Date(Now())) And assi.ia_assi_priority < 9) Or
            (assi.ia_user_sysid = 855 And assi.ia_assi_finishdate Between Concat(Year(Date_Add(Now(), Interval
            -1 Year)), '1001') And Concat(Year(Date(Now())), '0930')) Or
            (assi.ia_assi_permission = 855 And assi.ia_assi_finishdate Between Concat(Year(Date_Add(Now(), Interval -1
            Year)), '1001') And Concat(Year(Date(Now())), '0930'))
        Else (assi.ia_user_sysid = 855 And assi.ia_assi_year = Year(Date_Add(Now(), Interval 1 Year))) Or
            (assi.ia_assi_permission = 855 And assi.ia_assi_year = Year(Date_Add(Now(), Interval 1 Year))) Or
            (assi.ia_user_sysid = 855 And assi.ia_assi_year < Year(Date_Add(Now(), Interval 1 Year)) And
            assi.ia_assi_priority < 9) Or
            (assi.ia_assi_permission = 855 And assi.ia_assi_year < Year(Date_Add(Now(), Interval 1 Year)) And
            assi.ia_assi_priority < 9) Or
            (assi.ia_user_sysid = 855 And assi.ia_assi_finishdate Between Concat(Year(Date(Now())), '1001') And
            Concat(Year(Date_Add(Now(), Interval 1 Year)), '0930')) Or
            (assi.ia_assi_permission = 855 And assi.ia_assi_finishdate Between Concat(Year(Date(Now())), '1001') And
            Concat(Year(Date_Add(Now(), Interval 1 Year)), '0930'))
    End
Group By
