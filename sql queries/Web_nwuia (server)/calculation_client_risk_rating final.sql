...
From
    ...
    ia_finding_likelihood alik On alik.ia_findlike_auto = find.ia_findlike_auto_client Inner Join
    ia_finding_rate arat On arat.ia_findrate_auto = find.ia_findrate_auto_client Inner Join
    ia_finding_control acon On acon.ia_findcont_auto = find.ia_findcont_auto_client Inner join
