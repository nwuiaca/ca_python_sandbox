...
Where
    Case
      ...
      Then (assi.ia_assi_year = Year(Date_add(Now(), Interval -1 Year)) And cate.ia_assicate_private = '0')
        Or (assi.ia_assi_year < Year(Date_add(Now(), Interval -1 Year)) And cate.ia_assicate_private = '0' And assi.ia_assi_priority < 9)
        Or (assi.ia_assi_finishdate between Concat(Year(Date_add(Now(), Interval -2 Year)), '1001') And Concat(Year(Date_add(Now(), Interval -1 Year)), '0930') And cate.ia_assicate_private = '0')
      Else (assi.ia_assi_year = Year(Date_add(Now(), Interval -1 Year)) And cate.ia_assicate_private = '0')
        Or (assi.ia_assi_year < Year(Date_add(Now(), Interval -1 Year)) And cate.ia_assicate_private = '0' And assi.ia_assi_priority < 9)
        Or (assi.ia_assi_finishdate between Concat(Year(Date_add(Now(), Interval -2 Year)), '1001') And Concat(Year(Date_add(Now(), Interval -1 Year)), '0930') And cate.ia_assicate_private = '0')
    End
Group By
